let bigdata = {
    "data": [{"id": "AED", "name": "United Arab Emirates Dirham", "min_size": "0.01000000"}, {
        ...
        "name": "Tunisian Dinar",
        "min_size": "0.00100000"
    }, {"id": "TOP", "name": "Tongan Paʻanga", "min_size": "0.01000000"}, {
        "id": "TRY",
        "name": "Turkish Lira",
        "min_size": "0.01000000"
...
// for (let i = 0; i < bigdata.data.length; i++){
//     console.log(typeof i);
//     console.log(typeof bigdata.data[i])
//     console.log(bigdata.data[i].name)
//     console.log( bigdata.data[i].id)
//     console.log(bigdata.data[i].min_size)
// };



// paprastesnis pavyzdys 
const iterator = bigdata.data.values()

for(const value of iterator){
    console.log(value)
    console.log(value.id)
    console.log(value.name)
    console.log(value.min_size)
